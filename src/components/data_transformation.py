...
# data Ingetionconfig class
class DataTransformation:
    def __init__(self):
        # created instance of DataTransformation class 
    ...
    def get_data_transformation_object(self):
        try:
            ...
            logging.info("pipelining concept Initiated")
            ## Numerical Pipeline
            ...
            ## joining the categorcal and numerical piplines
            ...
            logging.info("pipe lining completed")
